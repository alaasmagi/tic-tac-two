...
{
    private static IConfigRepository ConfigRepository = new ConfigRepositoryDb();
    ...
    public static string MainLoop()
    {
        ...
        ConfigRepository.CreateGameConfig(addConfig);
        return "";
    }
    ...
    private static string CreateConfigName()
    {
        ...
        do
        {
            ...
            nameCheck = ConfigRepository.DoesConfigExist(configName);

            if (nameCheck)
            {
                nameCheck = OverWrite(configName);
            }
    ...
    public static bool OverWrite(string fileName)
    {
